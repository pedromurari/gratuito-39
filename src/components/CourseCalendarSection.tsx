...
const COURSE_DAYS = new Set([7, 8, 9]);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            {[
              { dia: "07", mes: "Julho", diaSemana: "Terça-feira", aula: "Aula 01" },
              { dia: "08", mes: "Julho", diaSemana: "Quarta-feira", aula: "Aula 02" },
              { dia: "09", mes: "Julho", diaSemana: "Quinta-feira", aula: "Aula 03" },
